...
urlpatterns = [
    ...
    # parties: edits
    path("acts/party/<uuid:party_uuid>/toggle/", views.ActPartyToggleEnabledView.as_view(), name="act_party_toggle_enabled"),
    path("acts/party/<uuid:party_uuid>/set-org/", views.ActPartySetOrganizationView.as_view(), name="act_party_set_org"),

    # parties: conflicts (candidates + choose)
    path("acts/party/<uuid:party_uuid>/candidates/", views.ActPartyCandidatesView.as_view(), name="act_party_candidates"),
    path("acts/party/<uuid:party_uuid>/choose/", views.ActPartyChooseAuthorizationView.as_view(), name="act_party_choose_authorization"),
